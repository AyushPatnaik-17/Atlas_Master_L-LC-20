...
public class SequentialAnimation : MonoBehaviour
{
    ...
    IEnumerator AnimateSequence()
    {
        ...
        yield return MoveAndDisappear(Pin, new Vector3(0, -0.629f, 3.617f), 2f);
        ...
        yield return MoveAndDisappear(topScrews, new Vector3(0f, 0f, 0.7f), 2f);


        yield return RotateObject(separationPlate, new Vector3(0, 0, RotationValue), 3f);
